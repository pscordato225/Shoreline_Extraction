...
%Load the transects and the x and y coordinates data
load D:\Scordato_SSF_2018\Source_Code\Shoreline_Extraction\transect_data
%Load the image 
load 'D:\Scordato_SSF_2018\Source_Code\frameRect';
% Iplan= imagesc(frameRect.x, frameRect.y, unint8(frameRect.I))
